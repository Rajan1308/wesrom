...
<?php if ( is_active_sidebar( 'hero' ) ) : ?>
	...
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" data-bs-ride="carousel" data-interval="false" data-bs-interval="false">
		...
		<a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev" data-bs-slide="prev">
			...
			<span class="screen-reader-text"><?php echo esc_html_x( 'Previous', 'carousel control', 'wesrom' ); ?></span>
		...
		<a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next" data-bs-slide="next">
			...
			<span class="screen-reader-text"><?php echo esc_html_x( 'Next', 'carousel control', 'wesrom' ); ?></span>
