...
if ( ! function_exists( 'wesrom_pagination' ) ) {
	/**
	 ...
	 */
	function wesrom_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'wesrom' ),
				'next_text'          => __( '&raquo;', 'wesrom' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'wesrom' ),
			)
		);
