...
add_filter( 'comment_form_default_fields', 'wesrom_bootstrap_comment_form_fields' );

if ( ! function_exists( 'wesrom_bootstrap_comment_form_fields' ) ) {
	/**
	 ...
	 * @return array
	 */
	function wesrom_bootstrap_comment_form_fields( $fields ) {
...
} // End of if function_exists( 'wesrom_bootstrap_comment_form_fields' )

// Add Bootstrap classes to comment form submit button and comment field.
add_filter( 'comment_form_defaults', 'wesrom_bootstrap_comment_form' );

if ( ! function_exists( 'wesrom_bootstrap_comment_form' ) ) {
	/**
	 ...
	 * @return string[]
	 */
	function wesrom_bootstrap_comment_form( $args ) {
		$replace = array(
			'<p class="' => '<div class="form-group mb-3 ',
...
} // End of if function_exists( 'wesrom_bootstrap_comment_form' ).


// Add note if comments are closed.
add_action( 'comment_form_comments_closed', 'wesrom_comment_form_comments_closed' );

if ( ! function_exists( 'wesrom_comment_form_comments_closed' ) ) {
	/**
	 * Displays a note that comments are closed if comments are closed and there are comments.
	 */
	function wesrom_comment_form_comments_closed() {
...
} // End of if function_exists( 'wesrom_comment_form_comments_closed' ).
