...
add_action( 'after_setup_theme', 'wesrom_block_editor_setup' );

if ( ! function_exists( 'wesrom_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function wesrom_block_editor_setup() {
		...
		$color_palette = wesrom_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'wesrom_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function wesrom_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'wesrom_theme_editor_color_palette', $color_palette );
	}
}
