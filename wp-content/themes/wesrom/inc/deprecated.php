...
if ( ! function_exists( 'wesrom_adjust_body_class' ) ) {
	 ...
	 */
	function wesrom_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'wesrom_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function wesrom_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'wesrom' ),
		__( 'Previous', 'wesrom' ),
		__( 'Next', 'wesrom' ),
		__( 'About:', 'wesrom' ),
		__( 'Profile', 'wesrom' ),
		__( 'Posts by', 'wesrom' ),
		__( 'Permanent Link:', 'wesrom' ),
		__( 'in', 'wesrom' ),
		__( 'Edit', 'wesrom' ),
	);
}
