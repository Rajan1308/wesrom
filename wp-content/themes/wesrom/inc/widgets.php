 ...
 */
add_filter( 'dynamic_sidebar_params', 'wesrom_widget_classes' );

if ( ! function_exists( 'wesrom_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function wesrom_widget_classes( $params ) {
...
} // End of if function_exists( 'wesrom_widget_classes' ).

add_action( 'widgets_init', 'wesrom_widgets_init' );

if ( ! function_exists( 'wesrom_widgets_init' ) ) {
	/**
	...
	function wesrom_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'wesrom' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'wesrom' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'wesrom' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'wesrom' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'wesrom' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'wesrom' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'wesrom' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'wesrom' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'wesrom' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'wesrom' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'wesrom' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'wesrom' ),
...
} // End of function_exists( 'wesrom_widgets_init' ).
